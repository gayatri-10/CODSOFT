...
if __name__ == "__main__":
    ...
    header_frame = tk.Frame(guiWindow, bg="#CDAA7D")
    functions_frame = tk.Frame(guiWindow, bg="#CDAA7D")
    listbox_frame = tk.Frame(guiWindow, bg="#CDAA7D")
